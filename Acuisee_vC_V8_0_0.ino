...
//  leftPBstate        = !(leftPBstate);           // previous state of left PB, LOW = true
//  rightPBstate       = !(rightPBstate);          // previous state of right PB, LOW = true
//  stepFwdPBstate     = !(stepFwdPBstate);        // previous state of PB, LOW = true
//  stepRevPBstate     = !(stepRevPBstate);        // previous state of PB, LOW = true
//  stepRetLSstatestate     = !(stepRetLSstatestate);        // previous state of LS
